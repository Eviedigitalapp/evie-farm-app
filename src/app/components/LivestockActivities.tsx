...
import { Plus, User, CheckSquare, ListTodo, Clock, AlertCircle, Trash2 } from 'lucide-react';
...
export function LivestockActivities() {
  ...
  const [tasks, setTasks] = useLocalStorage<Task[]>('livestock-tasks', [
    {
      id: 1,
      taskName: 'Vaccinate Pigs - ASF',
      assignedTo: 'Dr. Moses Okello',
      dueDate: '2026-05-20',
      priority: 'high',
      animalType: 'Pigs',
      animalSection: 'Pig Pen A',
      description: 'African Swine Fever vaccination for all 25 pigs',
      status: 'pending',
    ...
    },
    {
      ...
      description: 'Morning and evening feeding for 120 layers',
      status: 'in-progress',
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="font-semibold mb-2">Livestock Tasks & Work Assignments</h1>
        ...
        <div className="bg-white rounded-lg border-2 border-blue-500 p-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                type="text"
                placeholder="e.g., Vaccinate Pigs"
          ...
          <div className="bg-white rounded-lg max-w-2xl w-full p-6">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                {selectedTask.animalType && (
                  <div>
                    <p className="text-gray-600 mb-1">Animal Type</p>
                    <p className="font-semibold">{selectedTask.animalType}</p>
                  </div>
                )}
                {selectedTask.animalSection && (
                  <div>
                    <p className="text-gray-600 mb-1">Section</p>
                    <p className="font-semibold">{selectedTask.animalSection}</p>
                  </div>
                )}
              </div>
                ...
                >
                  <div className="flex items-start justify-between mb-2">
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">{task.animalType} - {task.animalSection}</p>
                    </div>
